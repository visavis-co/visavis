...
export const ENTER_PASSWORD_OLD = "ENTER_PASSWORD_OLD";
...
export const HANDLE_SELECTED_FILE = 'HANDLE_SELECTED_FILE';
export const UPDATE_CHAT_MSG = 'UPDATE_CHAT_MSG';
export const TOGGLE_MATCH_ONLINE = 'TOGGLE_MATCH_ONLINE';
export const ADD_CHAT_MESSAGE = 'ADD_CHAT_MESSAGE';
export const TOGGLE_SUCCESS_MESSAGE = 'TOGGLE_SUCCESS_MESSAGE' 
export const TOGGLE_SERVER_RESPONSE = 'TOGGLE_SERVER_RESPONSE'